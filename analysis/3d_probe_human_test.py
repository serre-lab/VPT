...
# Get model data
model_performance = pd.read_csv(os.path.join(data_folder, "Perspective_Results_new_result.csv"))
...
model_performance["VPT Accuracy"] = model_performance.perspective_accuracy_human / 100.
model_performance["Depth Perception Accuracy"] = model_performance.depth_accuracy_human / 100.
...
model_scores_depth = pd.read_csv(os.path.join(data_folder, "Perspective_Results_depth_linear_probe.csv"))
model_scores_vpt = pd.read_csv(os.path.join(data_folder, "Perspective_Results_perspective_linear_probe.csv"))
