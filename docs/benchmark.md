...
<figure>
    ...
    <figcaption text-align:left><b>DNN performance on the depth order and VPT-basic tasks in the 3D-PC after linear probing or prompting.</b> <b>(A, B)</b> DNNs are significantly more accurate at depth order than VPT-basic. Human confidence intervals are S.E.M. and ***: p < 0.001. <b>(C, D)</b> DNN accuracy for depth order and VPT-basic strongly correlates with object classification accuracy on ImageNet. Dashed lines are the mean of label-permuted human noise floors.</figcaption>
</figure>
...
<figure>
    ...
    <figcaption text-align:left><b>DNN performance on the depth order and VPT-basic tasks in the 3D-PC after fine-
